...
class ShopPhonePage(BasePage):
    ...
    def clicks_on_button_log_in_bye(self):
        ...
        phone_name_and_colour = \
            self.element_is_visible(self.shop_phone_page_locator.PHONE_NAME_AND_COLOUR_HEADER).get_attribute("innerText")
        ...
        print(f"\nВыдан {phone_name_and_colour}, вариант оплаты {payment_option}")
