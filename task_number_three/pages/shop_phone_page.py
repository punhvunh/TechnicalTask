...
class ShopPhonePage(BasePage):
    ...
    def clicks_on_button_log_in_and_buy(self):
        ...
        self.clicks_on_element(self.shop_phone_page_locator.LOG_IN_AND_BUY_BUTTON_XPATH)
        self.element_is_not_visible(self.shop_phone_page_locator.LOG_IN_AND_BUY_BUTTON)
